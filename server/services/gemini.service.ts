...
import { withApiRotation } from '../api-rotation';
...
class GeminiService {
  ...
  constructor(apiKey?: string) {
    // Não inicializar aqui, será feito dinamicamente com rotação
    console.log('[GeminiService] Inicializado com rotação de APIs');
  }
